...
Current Zephyr's ESP32-S2-devkitm board supports the following features:
...
.. zephyr-app-commands::
   ...
   :board: esp32s2_devkitm
   :goals: build

The usual ``flash`` target will work with the ``esp32s2_devkitm`` board
...
.. _ESP32-S2 DevKitC User Guide: https://docs.espressif.com/projects/esp-idf/en/latest/esp32s2/hw-reference/esp32s2/user-guide-s2-devkitm-1.html
